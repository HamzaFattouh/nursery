    ...
    <div className="signuppage">
      <div className="signupcontainer">
        ...
        <form onSubmit={handleSendCode}>
          ...
          {/* <div className="option-list" value={user.selectedMajored} onChange={handleSelectedMajored} ><h5>اختر التخصص:</h5>
          ...
          <button className="submitbtn" type="submit">تسجيل</button>
        </form>
        {signupResult && (
          <div>
            {signupResult.error ? (
